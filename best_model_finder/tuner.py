...
class Model_Finder:
    ...
    def get_best_params_for_naive_bayes(self,train_x,train_y):
        ...
        try:
            ...
            self.param_grid = {"var_smoothing": [1e-9,0.1]}
    ...
    def get_best_model(self,train_x,train_y,test_x,test_y):
        ...
        try:
            ...
            if len(test_y.unique()) == 1: #if there is only one label in y, then roc_auc_score returns error. We will use accuracy in that case
                ...
                print("3")
                self.xgboost_score = accuracy_score(test_y, self.prediction_xgboost) # AUC for XGBoost
                print("4")
            ...
            if len(test_y.unique()) == 1:#if there is only one label in y, then roc_auc_score returns error. We will use accuracy in that case
                ...
                self.naive_bayes_score = accuracy_score(test_y,self.prediction_naive_bayes) # AUC for Random Forest
